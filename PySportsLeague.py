...
st.set_page_config(page_title = 'PySportsL€agu€', page_icon = '🏅',layout = 'wide', initial_sidebar_state = 'auto' )

st.title(body = 'PySportsL€agu€')
...
def List_NBA_Teams() -> dict:
	try:
		response = requests.geturl = ('https://balldontlie.io/api/v1/teams').json()
		dataset: list = [ {
